...
description: "Documentation for Cai, the action layer for macOS. Installation, LLM setup, custom actions, GitHub and Linear connectors, and keyboard shortcuts."
---
...
- **[Ask AI](/docs/usage/custom-actions/)**: run any AI prompt on your selected text
