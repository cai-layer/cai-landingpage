...
Save a shell command that runs with your selected text. Use this to automate workflows, trigger scripts, or pipe text to command-line tools.

**Examples:**
- `echo "%s" | pbcopy`: transform and re-copy
- `gh issue create --title "%s"`: create a GitHub issue
- `say "%s"`: read your selected text aloud
...
3. Click the add button and fill in:
   ...
   - **Value**: the prompt instruction, URL template (use `%s` for your selected text), or shell command
